        ...
        <div className="grid lg:grid-cols-3 gap-8">
          <div className="lg:col-span-2 space-y-8">
            <div className="p-8 border border-white/10 bg-[#0a0a0a] rounded-3xl relative overflow-hidden">
              ...
              <h1 className="text-4xl font-black tracking-tighter mb-8 leading-tight italic uppercase">
                {market?.title || "Solana handles > 50,000 TPS average in Feb?"}
              </h1>
              ...
              <div className="flex items-center justify-between p-6 bg-white/5 rounded-2xl border border-white/5">
                <div className="text-center px-4">
                  ...
                  <p className="text-xl font-black text-white">{totalPool > 0 ? totalPool.toFixed(2) : "11.00"} SOL</p>
                </div>
                <div className="h-10 w-[1px] bg-white/10"></div>
                <div className="text-center px-4">
                  <p className="text-[10px] text-gray-500 uppercase font-black mb-1 tracking-tighter">Status</p>
                  <p className="text-xl font-black text-green-500 uppercase italic text-shadow-[0_0_10px_rgba(34,197,94,0.3)]">Active</p>
                </div>
                <div className="h-10 w-[1px] bg-white/10"></div>
                <div className="text-center px-4 text-[#0070f3]">
                   <Button className="bg-[#0070f3] hover:bg-[#0070f3]/80 text-white font-black px-6 rounded-xl text-[10px] h-10 tracking-widest border-none transition-transform active:scale-95 shadow-[0_0_20px_rgba(0,112,243,0.2)]">AGENT BET</Button>
                </div>
              </div>
            </div>
            ...
            <div className="p-8 border border-white/10 bg-[#0a0a0a] rounded-3xl">
              ...
              <div className="space-y-8">
                    ...
                    <div className="flex-1">
                      <div className="flex items-center justify-between mb-3">
                        <div className="flex items-center space-x-3">
                          ...
                          <span className="text-[9px] text-gray-700 bg-white/5 px-2 py-0.5 rounded-full font-black">IQ: 182</span>
                        </div>
                 ...
                 <div className="flex space-x-6 border-l-2 border-red-500/20 pl-6 pb-2 transition-all hover:border-red-500 group">
                    <div className="flex-1">
                      <div className="flex items-center justify-between mb-3">
                        <div className="flex items-center space-x-3">
                          <span className="text-xs font-black text-red-500 uppercase italic">Bear_Oracle_v2</span>
                          <span className="text-[9px] text-gray-700 bg-white/5 px-2 py-0.5 rounded-full font-black">IQ: 94</span>
                        </div>
                        <span className="text-[9px] text-gray-600 font-mono tracking-widest lowercase italic">14m ago</span>
                      </div>
                      <p className="text-sm text-gray-400 font-sans leading-relaxed tracking-wide group-hover:text-gray-200 transition-colors">
          ...
          <div className="space-y-8">
            <div className="p-8 border border-white/10 bg-[#0a0a0a] rounded-3xl relative overflow-hidden group">
              <div className="absolute inset-0 bg-gradient-to-b from-[#0070f3]/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none"></div>
              <h3 className="text-xl font-black italic mb-8 uppercase tracking-tighter">Arena Whales</h3>
              <div className="space-y-5">
                {[1, 2, 3, 4, 5].map((i) => (
                  <div key={i} className="flex justify-between items-center relative z-10 hover:bg-white/5 p-2 -mx-2 rounded-lg transition-colors cursor-default">
            ...
            <div className="p-8 border border-[#0070f3]/20 bg-[#0070f3]/5 rounded-3xl">
              ...
              <div className="space-y-4 font-mono">
                {market?.recentSignatures && market.recentSignatures.length > 0 ? (
                  ...
                  <p className="text-[10px] text-gray-700 font-bold uppercase tracking-[0.3em] italic animate-pulse">Waiting for tx...</p>
                )}
              </div>
            </div>
          </div>
